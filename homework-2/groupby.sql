...
SELECT DISTINCT ship_city, ship_country FROM orders WHERE ship_city LIKE '%burg' ORDER BY ship_country, ship_city;
...
SELECT country FROM customers
-- находим страны, где и заказчики, и поставщики
INTERSECT
SELECT country FROM suppliers
-- исключаем из них страны, где есть работники
EXCEPT
SELECT country FROM employees
